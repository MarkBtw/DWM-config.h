...
/*my custom dwm color scheme*/
static const char col_special[]         = "#62001d";		/*This value sets color of the DWM top bar.*/
static const char col_red2[]            = "#d30f23";
static const char col_blue1[]       = "#1f2241";
static const char col_blue2[]       = "#000000";
...
//DEFAULT color scheme, uncomment all underneath this line to use.
...
//CUSTOM blue and red color scheme
 static const char *colors[][3]      = {
   /*               fg (text)   bg (behind text) border    */
     [SchemeNorm] = { col_white, col_gray1, col_gray2 },      //for non active tabs
     [SchemeSel]  = { col_white, col_special,  col_special }, //active tabs
 };
//themes work like layering so fg is the foreground (text)
//bg is behind the text, border are the edges around the window
